...
import { addAppCoures } from '../../actions/profileActions';
...
class AppDevReg extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fName: '',
  ...
  onSubmit(e) {
    ...
    this.props.addAppCoures(expData, this.props.history);
  }
...
<p><i className="fa fa-check-square-o" style={{padding: '5px'}}> </i>Manipulate behaviour of app with javaScript.</p>
...
<p><i className="fa fa-check-square-o" style={{padding: '5px'}}> </i>Built robust & secure app applications with Expo.io</p>
...
<p><i className="fa fa-check-square-o" style={{padding: '5px'}}> </i>Build any kind of app with Expo.</p>
<p><i className="fa fa-check-square-o" style={{padding: '5px'}}> </i>Push Apps to Google Play Store.</p>
<p><i className="fa fa-check-square-o" style={{padding: '5px'}}> </i>Understand the best practices for mobile app development.</p>
...
<input
  ...
  name="trainingType"
  checked={this.state.trainingType === "Mobile App Development"}
  onChange={this.onChange}
...
AppDevReg.propTypes = {
  addAppCoures: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { addAppCoures })(
  withRouter(AppDevReg)
);
